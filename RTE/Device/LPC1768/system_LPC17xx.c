...
#define PLL0_SETUP            1
#define PLL0CFG_Val           0x000B0095					//0x00050063 //Entre 275MHz y 550 Mhz => F_cco0 = (2 * M * F_in) / N;; 300e6 = (2 * 150 * 12e6) / 12
#define PLL1_SETUP            0										//1
#define PLL1CFG_Val           0x00000023
#define CCLKCFG_Val           0x00000002					//Divide por 3 los 300MHz y el resultado (100MHz) es la frecuencia del ciclo de instrucción (frec. principal)
#define USBCLKCFG_Val         0x00000000
#define PCLKSEL0_Val          0x00000000					//Divide directamente por 4 la frec. principal y el resultado es la frec. de refresco de los periféricos
#define PCLKSEL1_Val          0x00000000
#define PCONP_Val             0x042887DE					//Lleva alimentados todos los periféricos por defecto
